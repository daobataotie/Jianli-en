...
namespace Book.DA
{
    public interface IMiscDataAccessor : IAccessor
    {
        ...
        DataTable SelectForSupplierTransactionRank(DateTime startDate, DateTime endDate, string Startid, string EndId, string CategoryId);

        DataTable SelectForCustomerTransactionRank(DateTime startDate, DateTime endDate, string Startid, string EndId, string chStartid, string chEndid);
