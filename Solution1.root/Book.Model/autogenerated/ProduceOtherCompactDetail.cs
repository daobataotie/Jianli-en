...
// author: mayanjun
// create date：2012-5-19 11:46:15
//
//------------------------------------------------------------------------------
using System;
namespace Book.Model
{
	public partial class ProduceOtherCompactDetail
	{
		...
		/// 
		/// </summary>
		private double? _cancelQuantity;
		...
		public double? CancelQuantity
		{
			get 
			{
				return this._cancelQuantity;
			}
			set 
			{
				this._cancelQuantity = value;
			}
		}
		...
		/// 
		/// </summary>
		public readonly static string PRO_CancelQuantity = "CancelQuantity";
