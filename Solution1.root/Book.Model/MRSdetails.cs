...
namespace Book.Model
{
    ...
    public partial class MRSdetails
    {
        ...
        /// 制成品
        /// </summary>
        //public string MadeProductName { get; set; }
        ...
        /// 分配数量总计
        /// </summary>
        public double ProductFPSLsum
        {
            get
            {
                if (this.Product == null) return 0;
                else
                    return Convert.ToDouble(this.Product.ProduceMaterialDistributioned) + Convert.ToDouble(this.Product.OtherMaterialDistributioned);
            }
        }
