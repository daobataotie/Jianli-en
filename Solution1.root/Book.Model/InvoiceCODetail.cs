...
namespace Book.Model
{
    ...
    public partial class InvoiceCODetail
    {
        ...
        public string PrintPrice
        {
            get
            {
                string s = this.InvoiceCODetailPrice.HasValue ? global::Helper.DateTimeParse.GetSiSheWuRu(this.InvoiceCODetailPrice.Value, 2).ToString() : "";
                if (!string.IsNullOrEmpty(s) && this.Invoice.AtCurrencyCategory != null)
                    s = this.Invoice.AtCurrencyCategory.EnglishName + s;
                return s;
            }
        }
        ...
        public string PrintMoney
        {
            get
            {
                string s = this.InvoiceCODetailMoney.HasValue ? global::Helper.DateTimeParse.GetSiSheWuRu(this.InvoiceCODetailMoney.Value, 2).ToString() : "";
                if (!string.IsNullOrEmpty(s) && this.Invoice.AtCurrencyCategory != null)
                    s = this.Invoice.AtCurrencyCategory.EnglishName + s;
                return s;
            }
        ...
        public readonly static string PRO_PrintPrice = "PrintPrice";
        public readonly static string PRO_PrintMoney = "PrintMoney";
    }
}
