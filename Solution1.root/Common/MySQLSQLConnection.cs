...
namespace Common
{
    public class MySQLConnection : Connection
    {
        ...
        public override string ToString(string note)
        {
            ...
            switch (note)
            {
                ...
                case "r":
                    ...
                    break;
                case "m":
                    result = string.Format("Database={0};Data Source={1};User Id={2};Password={3};pooling=false;CharSet=utf8;port=3306", this.datasource, this.initialcatalog, this.username, this.password);                                  //测试连接MySQL
                    break;
            }
            return result;
        }
        ...
        public static MySQLConnection Parse(XmlNode connectionNode)
        {
        ...
        public override bool Awailable
        {
            get
            {
                ...
                SqlConnection conn = new SqlConnection(this.ToString("m"));
                try
                {
                    conn.Open();
                }
