...
namespace Book.BL
{
    ...
    public partial class InvoicePTManager : InvoiceManager
    {
        ...
        public IList<Model.InvoicePT> Select(DateTime startTime, DateTime endTime, string invoiceId, string employeeId, string depot, string depotIn, string productId)
        {
            return accessor.Select(startTime, endTime, invoiceId, employeeId, depot, depotIn, productId);
        }
        ...
        {
            return accessor.Select(startTime, endTime);
        }
