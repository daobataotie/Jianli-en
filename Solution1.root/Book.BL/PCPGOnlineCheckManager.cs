...
namespace Book.BL
{
    ...
    public partial class PCPGOnlineCheckManager : BaseManager
    {
        ...
        public System.Data.DataTable SelectDetailByDateRage(DateTime StartDate, DateTime EndDate, Model.Product product, Model.Customer customer, string CusXOId, string StartPronoteHeader, string EndPronoteHeader)
        {
            return accessor.SelectDetailByDateRage(StartDate, EndDate, product, customer, CusXOId, StartPronoteHeader, EndPronoteHeader);
        }
