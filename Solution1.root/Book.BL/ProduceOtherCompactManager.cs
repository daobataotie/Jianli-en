...
namespace Book.BL
{
    ...
    public partial class ProduceOtherCompactManager : BaseManager
    {
        ...
        public IList<Book.Model.ProduceOtherCompact> GetByDate(DateTime startDate, DateTime endDate, Model.Product sendProduct, string CustomerInvoiceXOId, string customerid, string supplierid, string ProduceOtherCompactId)
        {
            return accessor.GetByDate(startDate, endDate, sendProduct, CustomerInvoiceXOId, customerid, supplierid, ProduceOtherCompactId);
        }
