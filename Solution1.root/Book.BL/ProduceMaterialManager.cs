...
namespace Book.BL
{
    ...
    public partial class ProduceMaterialManager : BaseManager
    {
        ...
        private void UpdateAndInsert(Model.ProduceMaterial produceMaterial)
        {
            try
            {
                ...
                foreach (Model.ProduceMaterialdetails produceMaterialdetails in produceMaterial.Details)
                {
                    ...
                    {
                        throw new Helper.MessageValueException(product.ProductName + " ," + "The picking  quantity is greater than the number of unallocated");
                    }
                }
                BL.V.CommitTransaction();
            }
        ...
        {
            return accessor.SelectByDateRage(startdate, enddate, product, isNoClose);
        }
        ...
        public IList<Model.ProduceMaterial> SelectBycondition(DateTime starDate, DateTime endDate, string produceMaterialId0, string produceMaterialId1, Model.Product pId0, Model.Product pId1, string departmentId0, string departmentId1, string PronoteHeaderId0, string PronoteHeaderId1, string CusInvoiceXOId)
        {
