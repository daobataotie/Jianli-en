...
namespace Book.BL
{
    ...
    public partial class PCFinishCheckManager : BaseManager
    {
        ...
        public IList<Model.PCFinishCheck> SelectByDateRage(DateTime startdate, DateTime enddate, Model.Product product, string customerProductName, string CusXOId)
        {
            return accessor.SelectByDateRage(startdate, enddate, product, customerProductName, CusXOId);
        }
