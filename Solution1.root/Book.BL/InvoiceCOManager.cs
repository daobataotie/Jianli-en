...
namespace Book.BL
{
    ...
    public partial class InvoiceCOManager : InvoiceManager
    {
        ...
        {
            return accessor.SelectDateRangAndWhere(costartid, coendid, SupplierStart, SupplierEnd, dateStart, dateEnd, productStart, productEnd, cusxoid, dateJHStart, dateJHEnd, invoiceFlag);
        }
