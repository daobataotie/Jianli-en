...
namespace Book.BL
{
    ...
    public partial class ProduceOtherMaterialManager : BaseManager
    {
        ...
        public void Insert(Model.ProduceOtherMaterial produceOtherMaterial)
        {
            ...
            try
            {
                ...
                foreach (Model.ProduceOtherMaterialDetail produceOtherMaterialDetail in produceOtherMaterial.Details)
                {
                    ...
                    //已分配
                    produceOtherMaterialDetail.Distributioned = (product.ProduceMaterialDistributioned == null ? 0 : product.ProduceMaterialDistributioned) + (product.OtherMaterialDistributioned == null ? 0 : product.OtherMaterialDistributioned) + (produceOtherMaterialDetail.OtherMaterialQuantity == null ? 0 : produceOtherMaterialDetail.OtherMaterialQuantity);
        ...
        public string SelectByInvoiceCusID(string CustomerInvoiceXOId)
        {
            return accessor.SelectByInvoiceCusID(CustomerInvoiceXOId);
        }
