...
namespace Book.BL
{
    ...
    public partial class ProduceInDepotDetailManager : BaseManager
    {
        ...
        {
            return accessor.ProducePronotePlanReport(startdate, enddate, pronoteheaderid, xocustomerid, invoiceCusId, employeeid, pronotetype, workhouseid, productid, isJieAN);
        }

        public double GetTotalProceduresSumByPronote(string pronoteHeaderId)
        {
            return accessor.GetTotalProceduresSumByPronote(pronoteHeaderId);
        }
    }
}
