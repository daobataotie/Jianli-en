...
namespace Book.BL
{
    ...
    public partial class ProductManager : BaseManager
    {
        ...
        private static readonly DA.ISupplierProductAccessor supplierProductAccessor = (DA.ISupplierProductAccessor)Accessors.Get("SupplierProductAccessor");
        ...
        public void UpdateTiGuiExists(Model.Product product)
        {
            this.TiGuiExists(product);
            ////     string id = this.GetNewId(product.ProductCategory);
        ...
        {
            return accessor.GetProductByCondition(ProductCategoryName, pt);
        }
        ...
        {
            return accessor.SelectByIdAndName(id, productName);
        }
