...
namespace Book.BL
{
    ...
    {
        private BL.PCFogCheckDetailManager _pcfogcheckdetailmanager = new PCFogCheckDetailManager();
        ...
        public void Delete(Model.PCFogCheck pcfc)
        {
            try
            {
                ...
                this._pcfogcheckdetailmanager.DeleteByHeaderId(pcfc.PCFogCheckId);
