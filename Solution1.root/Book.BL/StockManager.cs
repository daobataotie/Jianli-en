...
namespace Book.BL
{
    ...
    public partial class StockManager : BaseManager
    {
        ...
        public System.Data.DataTable SelectDepotDistributedByproduct(string productid)
        {
            return accessor.SelectDepotDistributedByproduct(productid);
        }

        public double SelectStockQuantity0(string productid)
        {
            return accessor.SelectStockQuantity0(productid);
        }

        public DataTable SelectProductNoDepotout(double years)
        {
            return accessor.SelectProductNoDepotout(years);
        }

        public string GetLastDepotoutDate(string productid)
        {
            return accessor.GetLastDepotoutDate(productid);
        }
