...
namespace Book.UI
{
    class Operations
    {
        ...
        static Operations()
        {
            ...
            //应付账款明细表
            operations.Add("accountpayable.accquery.suppliermaychooseBiao", (D1)delegate(System.Windows.Forms.Form form) { M1("Query.ShouldPayForm", form); });
            ...
            operations.Add("Hr.Attendance.Leave.IntervalLeave", (D1)delegate(System.Windows.Forms.Form form) { M1("Hr.Attendance.Leave.IntervalLeave", form); });
            #endregion
            ...
            //生管未生产订单总表
            operations.Add("Query.ROJD_PronoteHeader", (D1)delegate(System.Windows.Forms.Form form) { MM("Query.ROJD_PronoteHeader", new Query.ROJD_PronoteHeaderContitionFrm()); });
            //外发合同
            ...
            operations.Add("settings.basicdata.productcategories-1", (D1)delegate(System.Windows.Forms.Form form) { M7("Settings.BasicData.ProductCategories.EditForm-1", form); });
            ...
            operations.Add("Accounting.Report.XRCashDebt", (D1)delegate(System.Windows.Forms.Form form) { M1("Accounting.AtCashAccount.EditForm", form); });
            ...
            //现金支出传票明细
            operations.Add("Accounting.Report.CashCreditSlipRO", (D1)delegate(System.Windows.Forms.Form form) { MM("Accounting.Report.CashCreditSlipRO", new Book.UI.Query.ConditionAChooseForm()); });

            //打印发票
            operations.Add("Query.ROFP", (D1)delegate(System.Windows.Forms.Form form) { MM("Query.ROFP", new Book.UI.Query.FormFP()); });

            //應付賬款發票
            operations.Add("Accounting.YPFP.EditForm", (D1)delegate(System.Windows.Forms.Form form) { M1("Accounting.YPFP.EditForm", form); });
        }
