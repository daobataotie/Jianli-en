...
namespace Book.UI.produceManager.MRSHeader
{
    public partial class SelectMrsHeaderAndDetails : XtraForm
    {
        ...
        private void simple_SearCh_Click(object sender, EventArgs e)
        {
            ...
            //    List.Add(Tp);
            //}
            this.bindingSourceMrsData.DataSource = this._mrsHeaderManager.SelectbyCondition(textEditId1.Text == "" ? null : textEditId1.Text, textEditId2.Text == "" ? null : textEditId2.Text, null, null, this.StartDate.DateTime, this.EndDate.DateTime, -1, null, null, this.txtCustomerId.Text, null);
        ...
        private void gridView3_CustomColumnDisplayText(object sender, DevExpress.XtraGrid.Views.Base.CustomColumnDisplayTextEventArgs e)
        {
            ...
            {
                Model.Product p = List[e.ListSourceRowIndex].Product;
                if (p != null)
                    e.DisplayText = p.StocksQuantity == null ? null : p.StocksQuantity.ToString();
            }
        }
    }
}
