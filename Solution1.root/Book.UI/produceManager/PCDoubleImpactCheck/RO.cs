...
namespace Book.UI.produceManager.PCDoubleImpactCheck
{
    public partial class RO : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public RO(Model.PCDoubleImpactCheck _pcdic)
        {
            ...
            //this.HeadTC_JiaRe.Text = _pcdic.JiaReWenDu;
            //this.HeadTC_LengDong.Text = _pcdic.LengDongWenDu;
            ...
            this.TCJiaRe.DataBindings.Add("Text", this.DataSource, Model.PCDoubleImpactCheckDetail.PRO_attrShangLiangL);
            this.TCBingDong.DataBindings.Add("Text", this.DataSource, Model.PCDoubleImpactCheckDetail.PRO_attrShangLiangR);
