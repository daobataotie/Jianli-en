...
namespace Book.UI.produceManager.PronoteHeader
{
    public partial class RO3 : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public RO3(string pronoteHeaderId, int flag)
        {
            ...
            this.xrLabelEmployee1.Text = this.pronoteHeader.AuditEmp == null ? "" : this.pronoteHeader.AuditEmp.EmployeeName;
            ...
            this.xrTableCellMachine.DataBindings.Add("Text", this.DataSource, Model.PronoteProceduresDetail.PRO_PronoteMachineId);
