...
namespace Book.UI.produceManager.ProduceOtherCompact
{
    ...
    public partial class ROContinuous : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public ROContinuous(ConditionOtherCompact condition)
        {
            ...
            {
                item.InvoiceXO = this.invoiceXOManager.Get(item.InvoiceXOId);
            }
        ...
        private void mBandData()
        {
            ...
            this.xrLabelCustomerXoId.DataBindings.Add("Text", this.DataSource, "invoiceXO.CustomerInvoiceXOId");
            this.xrLabelCustomer.DataBindings.Add("Text", this.DataSource, "invoiceXO.xocustomer." + Model.Customer.PRO_CustomerShortName);
            this.xrLabelCheck.DataBindings.Add("Text", this.DataSource, "invoiceXO.xocustomer." + Model.Customer.PRO_CheckedStandard);
            this.lblMRPId.DataBindings.Add("Text", this.DataSource, Model.ProduceOtherCompact.PRO_MRSHeaderId);
