...
namespace Book.UI.produceManager.ProduceInDepot
{
    public partial class ROProductDefectRate : DevExpress.XtraReports.UI.XtraReport
    {
            ...
            : this()
        {
            ...
            {
                throw new Helper.InvalidValueException("Product can not be empty");
            }
            ...
            {
                case 0:
                    this.lblReportName.Text = PrintYearAndMonth + " Product reject ratio statistical";
                    break;
                case 1:
                    this.lblReportName.Text = "Normal " + PrintYearAndMonth + " reject ratio statistical";
                    break;
                case 2:
                    this.lblReportName.Text = "Special " + PrintYearAndMonth + " reject ratio statistical";
                    break;
            }
            ...
            ProductAttrs += condition.attrQiangHua ? "Strengthen  " : " ";
            ProductAttrs += condition.attrWuDu ? "Haze  " : " ";
            ProductAttrs += condition.attrWuQiangHuaWuDu ? "No strengthen no haze  " : " ";
            this.lblProductAttrRange.Text = ProductAttrs;

            this.lblJiLuFangShi.Text = condition.attrJiLuFangShi ? "Unfold" : "Merger";
            ...
            {
                sb.Append(dat.Rows[i]["Workhousename"] + "：Total production：" + dat.Rows[i]["ProceduresSum"] + " Qualified quantity：" + dat.Rows[i]["CheckOutSum"] + " reject ratio：" + dat.Rows[i]["RejectionRate_1"] + "\t");
            }
