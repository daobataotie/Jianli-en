...
namespace Book.UI.AccountPayable.AcOtherShouldCollection
{
    public partial class XO : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public XO(string acOtherShouldCollectionId)
        {
            ...
            this.xrLabelDataName.Text = "Other receivables";
            this.xrLabelPrintDate.Text = "Print Date£º " + DateTime.Now.ToShortDateString();
            ...
            {
                case 0:
                    this.lblTaxCaluType.Text = "Tax exemption";
                    break;
                case 1:
                    this.lblTaxCaluType.Text = "Plus tax";
                    break;
                case 2:
                    this.lblTaxCaluType.Text = "Inclusive tax";
                    break;
            }
