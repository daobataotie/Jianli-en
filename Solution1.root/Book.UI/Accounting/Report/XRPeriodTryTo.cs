...
namespace Book.UI.Accounting.Report
{
    public partial class XRPeriodTryTo : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public XRPeriodTryTo(ConditionPeriodTryTo condition)
        {
            ...
            this.xrLabelDataName.Text = "During spreadsheet";
            ...
            if (list != null)
            {
                ...
                {
                    at.J = new BL.AtSummonDetailManager().CountSummonTo("Borrow", at.SubjectId);
                    at.K = new BL.AtSummonDetailManager().CountSummonTo("Loan", at.SubjectId);
