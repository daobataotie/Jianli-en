...
namespace Book.UI.Accounting.AtCashAccount
{
    public partial class ROList : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        //public ROList(Model.AtCashAccount model)
        //    : this()
        //{
        //    this.lblCompanyName.Text = BL.Settings.CompanyChineseName;
        //    this.lblReportDate.Text += DateTime.Now.ToString("yyyy-MM-dd");
        //    this.lblMonth.Text = model.AtCashAccountMonth.Value.ToString("yyyy-MM");
        ...
        public ROList(Query.ConditionA condition)
            : this()
        {
            this.lblCompanyName.Text = BL.Settings.CompanyChineseName;
            this.lblReportDate.Text += DateTime.Now.ToString("yyyy-MM-dd");
            ...
            this.lblMonth.Text = condition.StartDate == condition.EndDate ? condition.StartDate.ToString("yyyy-MM-dd") : condition.StartDate.ToString("yyyy-MM-dd") + " - " + condition.EndDate.ToString("yyyy-MM-dd");
            ...
            this.lblBalance.Text = (Convert.ToDecimal(this.lblIncome.Text) - Convert.ToDecimal(this.lblPay.Text)).ToString();
