...
namespace Book.UI.Query
{
    public class ConditionCO : ConditionA
    {
        ...
        public DateTime? EndInvoiceDate
        {
            get
            {
                return _endInvoiceDate.Value.Date.AddDays(1).AddSeconds(-1);
            }
            set { _endInvoiceDate = value; }
        }

        /// <summary>
        /// 进货单号开始
        /// </summary>
        public string InvoiceCGIdStart { get; set; }

        /// <summary>
        /// 进货单号结束
        /// </summary>
        public string InvoiceCGIdEnd { get; set; }
    }
}
