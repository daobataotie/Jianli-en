...
// 修 改 人:                          修改时间:
//----------------------------------------------------------------*/
    public partial class Q50 : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public Q50(ConditionMaterial condition)
        {
            ...
            {
                this.xrRichText1.Text += "\r\n" + detail.ProductName + " :" + "     Total quantity:" + detail.Materialprocessum + "     Has allocated quantity:" + detail.Materialprocesedsum;
            }
        }
