...
//----------------------------------------------------------------*/
    public partial class Q48 : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public Q48(ConditionMPS condition)
        {
            ...
            this.xrLabelDateRage.Text += "To：" + condition.EndDate.ToShortDateString();
            ...
            this.xrTableCustomer.DataBindings.Add("Text", this.DataSource, "Customer." + Model.Customer.PRO_CustomerShortName);
            this.xrTableCount.DataBindings.Add("Text", this.DataSource, Model.MPSdetails.PRO_InvoiceXODetailSum);
