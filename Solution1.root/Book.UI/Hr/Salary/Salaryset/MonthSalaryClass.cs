...
namespace Book.UI.Hr.Salary.Salaryset
{
    public class MonthSalaryClass
    {
        ...
        {
            get { return SubTotal - mLunchFee - mInsurance - mLoanFee - mJiuYuanKouJiao; }
        }
        ///<summary>
        /// 出勤奖金
        ///</summary>
        ...
        public double BonusTotal
        {
            get
            {
                double tb = mDutyPay + mSpecialBonus + mPostPay + mEffectFactor + mOtherPay - mOtherPunish;
        ...
        /// 就源扣缴
        /// </summary>
        private double _mJiuYuanKouJiao;
        /// <summary>
        /// 就源扣缴
        /// </summary>
        public double mJiuYuanKouJiao
        {
            get { return _mJiuYuanKouJiao; }
            set { _mJiuYuanKouJiao = value; }
        }
        /// <summary>
        /// 设定的出勤奖金
        /// </summary>
        private double _DutyPayTotal;
        /// <summary>
        /// 设定的出勤奖金
        /// </summary>
        public double DutyPayTotal
        {
            get { return _DutyPayTotal; }
            set { _DutyPayTotal = value; }
        }
        /// <summary>
        /// 总计
        /// </summary>
        ...
        public double Total
        {
            get { return mBasePay + TimeBonus + mDutyPay + mSpecialBonus + mPostPay + _mEffectFactor + mOtherPay - mOtherPunish + mAnnualHolidayFee + _mGeneralOverTimeFee + mHolidayOverTimeFee - mLatePunish; }
        }

        #region 2013年3月26日11:04:52 Creator:CN Desc: 改变薪资界面,增加 小计&加班
        /// <summary>
        ...
        public double XiaoJI
        {
            get
            {
                double tb = mBasePay + TimeBonus + mAnnualHolidayFee - mLatePunish;
                double tb_1 = Math.Truncate(tb * 10) % 10;
                if (tb_1 >= 5)
                {
                    return Math.Truncate(tb) + 1;
        ...
        #region 2013年5月20日11:26:04 Creator:CN Desc:薪资增加<时数补贴>
        /// <summary>
        /// 时数补贴
        /// </summary>
        private double _TimeBonus;
