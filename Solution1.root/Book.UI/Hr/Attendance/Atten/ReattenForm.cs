    ...
    internal partial class ReattenForm : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void btnReatten_Click(object sender, EventArgs e)
        {
            ...
            if (SelectItems.Count == 0)
            {
                if (this.nccEmployee.EditValue == null)
                {
                    MessageBox.Show("Please select employee who need Re-attendance", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return;
                }
                else
                {
            ...
            if (MessageBox.Show("After re-attendance, the staff of the section all attendance records [manually] input will be replaced!", "Please reconfirm", MessageBoxButtons.YesNo) == DialogResult.Yes)
            {
                do
                {
            ...
            MessageBox.Show("Re-attendance success", "Prompt", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
        ...
        private void btnSelectAllEmp_Click(object sender, EventArgs e)
        {
            if (selectAllFlag)
            {
                ...
                selectAllFlag = false;
                this.btnSelectAllEmp.Text = "Uncheck all";
            }
            else
            {
                foreach (Model.Employee item in this.bindingSourceEmployee.DataSource as IList<Model.Employee>)
                ...
                selectAllFlag = true;
                this.btnSelectAllEmp.Text = "check all";
            }
