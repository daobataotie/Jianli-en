...
//----------------------------------------------------------------*/
    public partial class MaterialXR : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public MaterialXR(System.Collections.Generic.IList<Model.BomComponentInfo> detail, Model.BomParentPartInfo par)
            : this()
        {
            if (par != null && par.Product != null)
            {
                ...
                //if (par.Product.CustomerId != null)
                //    this.xrLabelCustomer.Text = new BL.CustomerManager().Get(par.Product.CustomerId) == null ? "" : new BL.CustomerManager().Get(par.Product.CustomerId).CustomerFullName;
                //this.xrLabelCustomerProductName.Text = par.Product.CustomerProductName;
            }
