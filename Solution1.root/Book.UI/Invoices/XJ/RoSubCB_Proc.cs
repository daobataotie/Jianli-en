...
namespace Book.UI.Invoices.XJ
{
    public partial class RoSubCB_Proc : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public RoSubCB_Proc()
        {
            ...
            this.chkIsMustProc.DataBindings.Add("Checked", this.DataSource, Model.InvoiceXJProcess.PROPERTY_ISMUSTPROC);
            this.RTInvoiceXJProcessDesc.DataBindings.Add("Rtf", this.DataSource, Model.InvoiceXJProcess.PROPERTY_INVOICEXJPROCESSDESC);
            this.TCUnitPrice.DataBindings.Add("Text", this.DataSource, Model.InvoiceXJProcess.PRO_DanJia, "{0:0.###}");
        ...
        private void RoSubCB_Proc_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            var list = (from item in this._InvoiceXJ.DetailsProcess
            ...
            this.TCGuanXiao_Proc.Text += this._InvoiceXJ.GuanXiaoProc == 0 ? "    " : this._InvoiceXJ.GuanXiaoProc.Value.ToString();
        }
    }
}
