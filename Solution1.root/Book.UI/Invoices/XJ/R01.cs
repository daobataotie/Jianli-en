...
namespace Book.UI.Invoices.XJ
{
    public partial class R01 : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public R01(string invoiceid)
        {
            ...
            this.xrLabelTotal1.Text = this.invoice.InvoiceTotal.Value.ToString("F4");
            this.xrLabelNote.Text = this.invoice.InvoiceNote;
            if (this.invoice.AuditEmp != null)
                this.lbl_AuditEmp.Text = this.invoice.AuditEmp.ToString();
            ...
            this.xrTableCellQuantity.DataBindings.Add("Text", this.DataSource, Model.InvoiceXJDetail.PRO_InvoiceXJDetailQuantity);
            this.xrTableCellProductUnit.DataBindings.Add("Text", this.DataSource, Model.InvoiceXJDetail.PRO_InvoiceProductUnit);
            this.xrTableCellUintPrice.DataBindings.Add("Text", this.DataSource, Model.InvoiceXJDetail.PRO_InvoiceXJDetailPrice, "{0:0.####}");
            this.xrTableCellMoney.DataBindings.Add("Text", this.DataSource, Model.InvoiceXJDetail.PRO_InvoiceXJDetailMoney, "{0:0.####}");
            this.xrTableCellCustomerProductName.DataBindings.Add("Text", this.DataSource, Model.InvoiceXJDetail.PRO_ProductName);
