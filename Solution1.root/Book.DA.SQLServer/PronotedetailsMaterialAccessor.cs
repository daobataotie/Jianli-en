...
namespace Book.DA.SQLServer
{
    ...
    public partial class PronotedetailsMaterialAccessor : EntityAccessor, IPronotedetailsMaterialAccessor
    {
        ...
        public Model.PronotedetailsMaterial GetFirstByHeaderId(string p)
        {
            return sqlmapper.QueryForObject<Model.PronotedetailsMaterial>("PronotedetailsMaterial.GetFirstByHeaderId", p);
        }
    }
}
