...
namespace Book.DA.SQLServer
{
    ...
    public partial class CustomerAccessor : EntityAccessor, ICustomerAccessor
    {
        ...
        public Model.Customer SelectByIdAndFullName(string Id, string customerFullName)
        {
            Hashtable ht = new Hashtable();
            ht.Add("id", Id);
            ht.Add("CustomerFullName", customerFullName);
            return sqlmapper.QueryForObject<Model.Customer>("Customer.SelectByIdAndFullName", ht);
        }
    }
}
