...
namespace Book.DA.SQLServer
{
    ...
    public partial class MonthlySalaryAccessor : EntityAccessor, IMonthlySalaryAccessor
    {
        ...
        public IList<Book.Model.MonthlySalary> SelectForSpecialMonth(int year, int month)
        {
            Hashtable ht = new Hashtable();
            ht.Add("year", year);
            ht.Add("month", month);
            return sqlmapper.QueryForList<Model.MonthlySalary>("MonthlySalary.SelectForSpecialMonth", ht);
        }
    }
}
