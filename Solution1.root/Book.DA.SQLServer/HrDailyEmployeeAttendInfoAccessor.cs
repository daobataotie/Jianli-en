...
namespace Book.DA.SQLServer
{
    ...
    public partial class HrDailyEmployeeAttendInfoAccessor : EntityAccessor, IHrDailyEmployeeAttendInfoAccessor
    {
        ...
        //求日基数
        public double GetDayFactorByEmployeeIdAndDate(string EmployeeId, DateTime date)
        {
            Hashtable ht = new Hashtable();
            ht.Add("EmployeeId", EmployeeId);
            ht.Add("date", date);
            return sqlmapper.QueryForObject<double>("HrDailyEmployeeAttendInfo.GetDayFactorByEmployeeIdAndDate", ht);
        }
    }
}
