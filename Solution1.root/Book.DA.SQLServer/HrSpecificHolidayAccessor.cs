...
namespace Book.DA.SQLServer
{
    ...
    public partial class HrSpecificHolidayAccessor : EntityAccessor, IHrSpecificHolidayAccessor
    {
        ...
        {
            return sqlmapper.QueryForObject<bool>("HrSpecificHoliday.IsExistForHolidayDate", dr["HolidayDate"].ToString());
        }

        public bool ISExistsByName(string Name)
        {
            return sqlmapper.QueryForObject<bool>("HrSpecificHoliday.ISExistsByName", Name);
        }
    }
}
